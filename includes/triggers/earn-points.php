...
class AutomatorWP_GamiPress_Earn_Points extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User earns points', 'automatorwp-gamipress' ),
            'select_option'     => __( 'User earns <strong>points</strong>', 'automatorwp-gamipress' ),
            /* translators: %1$s: Points amount. %2$s: Post title. */
            'edit_label'        => sprintf( __( 'User earns %1$s %2$s', 'automatorwp-gamipress' ), '{points}', '{points_type}' ),
            /* translators: %1$s: Points amount. %2$s: Post title. */
            'log_label'         => sprintf( __( 'User earns %1$s %2$s', 'automatorwp-gamipress' ), '{points}', '{points_type}' ),
            ...
            'options'           => array(
                'points' => array(
                    'from' => 'points',
                    'default' => __( 'any amount of', 'automatorwp-gamipress' ),
                    'fields' => array(
                        'points' => array(
                            'name' => __( 'Points amount:', 'automatorwp-gamipress' ),
                            'desc' => __( 'Leave blank for any amount of points.', 'automatorwp-gamipress' ),
                            'type' => 'text',
                            'default' => ''
                        )
                    )
                ...
                'points_type' => array(
                    ...
                    'fields' => array(
                        'points_type' => array(
                            ...
                            'type' => 'select',
                            'option_none' => true,
                            'option_none_label' => __( 'points of any type', 'automatorwp-gamipress' ),
            ...
            'tags' => array_merge(
                array(
                    'points_earned' => array(
                        'label'     => __( 'Points earned', 'automatorwp-gamipress' ),
                        'type'      => 'integer',
                        'preview'   => __( '100', 'automatorwp-gamipress' ),
                    ),
                ),
