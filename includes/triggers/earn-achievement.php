...
class AutomatorWP_GamiPress_Earn_Achievement extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User earns an achievement', 'automatorwp-gamipress' ),
            'select_option'     => __( 'User earns <strong>an achievement</strong>', 'automatorwp-gamipress' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User earns %1$s %2$s time(s)', 'automatorwp-gamipress' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User earns %1$s', 'automatorwp-gamipress' ), '{post}' ),
            ...
            'options'           => array(
                'post' => automatorwp_gamipress_utilities_post_option( array(
                    ...
                    'option_none_label' => __( 'any achievement', 'automatorwp-gamipress' ),
