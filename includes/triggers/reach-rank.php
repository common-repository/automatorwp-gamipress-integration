...
class AutomatorWP_GamiPress_Reach_Rank extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User reaches a rank', 'automatorwp-gamipress' ),
            'select_option'     => __( 'User reaches <strong>a rank</strong>', 'automatorwp-gamipress' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User reaches %1$s %2$s time(s)', 'automatorwp-gamipress' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User reaches %1$s', 'automatorwp-gamipress' ), '{post}' ),
            ...
            'options'           => array(
                'post' => automatorwp_gamipress_utilities_post_option( array(
                    ...
                    'option_none_label' => __( 'any rank', 'automatorwp-gamipress' ),
